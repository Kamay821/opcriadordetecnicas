...
export const GRAU_OPTIONS: { [key: number]: { max_points: number; max_dice: number; description: string } } = {
  ...
  2: {
    max_points: 6,
    max_dice: 6,
    description: "6d10 em um único alvo ou 6d6 em múltiplos alvos. Alcance em Esfera/Cilindro/Emanação: Até 4,5m. Alcance em Cone: Até 15m. Alcance em Linha: Toque ou 15m.",
  },
  3: {
    max_points: 9,
    max_dice: 9,
    description: "9d10 em um único alvo ou 9d6 em múltiplos alvos. Alcance em Esfera/Cilindro/Emanação: Até 6m. Alcance em Cone: Até 18m. Alcance em Linha: Toque ou 21m.",
  },
  4: {
    max_points: 12,
    max_dice: 12,
    description: "12d10 em um único alvo ou 12d6 em múltiplos alvos. Alcance em Esfera/Cilindro/Emanação: Até 7,5m. Alcance em Cone: Até 21m. Alcance em Linha: Toque ou 27m.",
  },
  5: {
    max_points: 15,
    max_dice: 15,
    description: "15d10 em um único alvo ou 15d6 em múltiplos alvos. Alcance em Esfera/Cilindro/Emanação: Até 9m. Alcance em Cone: Até 24m. Alcance em Linha: Toque ou 33m.",
  },
  6: {
    max_points: 18,
    max_dice: 18,
    description: "18d12 em um único alvo ou 18d6 em múltiplos alvos. Alcance em Esfera/Cilindro/Emanação: Até 10,5m. Alcance em Cone: Até 27m. Alcance em Linha: Toque ou 39m.",
  },
  7: {
    max_points: 21,
    max_dice: 21,
    description: "21d12 em um único alvo ou 21d6 em múltiplos alvos. Alcance em Esfera/Cilindro/Emanação: Até 12m. Alcance em Cone: Até 30m. Alcance em Linha: Toque ou 45m.",
  },
};
