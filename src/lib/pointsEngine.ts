 ...
 */
export const getEffectCost = (id: EffectId | string, grau: number | null, value: number = 0): number => {
  ...
  // A verificação é feita com `id as string` para garantir a compatibilidade de tipos.
  if ((id as string) === "condicao-extra") {
  ...
  switch (id) {
    ...
    case "aumentar-area": return value * 1;
